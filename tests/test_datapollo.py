# -*- coding: utf-8 -*-
"""Tests for `datapollo` package."""

import random

import pytest

from datapollo import datapollo
...
def test_sum_numbers(generate_numbers):
    ...
    our_result = datapollo.sum_numbers(generate_numbers)
...
def test_max_number(generate_numbers):
    ...
    our_result = datapollo.max_number(generate_numbers)
